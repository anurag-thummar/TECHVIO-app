  ...
  const fetchData = [
    {
      ...
      descriptionTitle: "Planning for Safe Return Workplace IT Solutions",
      ...
      <div className="container">
        <div className="home-blog-inner">
          <div className="home-blog-upper">
            <p className="center-text-title">Blog & Article</p>
            <h2 className="center-text-heading" id="home-blog-heading">
              Recent Blog
            </h2>
          </div>
