...
const blogRightSidebar = () => {
  ...
  return (
    <>
      <div className="blog_right_side_bar">
        <div className="container">
          <div className="blog_right_side_bar-inner">
            <div className="blog_right_side_bar-down-left">
              <div className="blog_right_side_bar-down-left-inner">
                {
                  blogData.map((blogElement) => (
                    // <div key={a}>
                    <div className="blog_right_side_bar-item">
                      <div className="blog_right_side_bar-item-inner">
                        <div className="blog_right_side_bar-img">
                          <img src={blogElement.img} alt="blog_right_side_bar-1" />
                        </div>

                        <div className="blog_right_side_bar-description">
                          <span></span>
                          <span></span>
                          <span></span>
                          <span></span>
                          ...
                          <div className="blog_right_side_bar-read-more">
                            <a href="#">
            ...
            <div className="blog_right_side_bar-down-right">
              <div className="blog_right_side_bar-down-right-inner">
